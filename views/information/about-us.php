    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="card shadow p-4">
                <div class="card-body">
                    <!-- title -->
                    <h2 class="fw-bold pb-3">درباره مایندباکس</h2>
                    <!-- text -->
                    <p class="text-about">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان
                        ...
                        می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان
