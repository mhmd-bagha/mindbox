            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 mb-4">
                <div class="card course-card h-100">
                    <a href="<?php echo DOMAIN ?>/courses/course_details/<?php echo $course_last->id ?>"><img
                                data-src="<?php echo DL_DOMAIN ?>/public/images/course/<?php echo $course_last->course_image . '/' . $course_last->course_image ?>"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <span class="user-course-card text-muted"><i
                                        class="fa-solid fa-user me-1"></i><?php $course_teacher = $this->model->where('admins', 'id', $course_last->course_teacher); echo $course_teacher->first_name . ' ' . $course_teacher->last_name ?></span>
