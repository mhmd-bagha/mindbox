<main>
    ...
    <div class="container-fluid px-0">
        <div class="owl-carousel owl-theme" id="slider">
            <div class="item">
                <a href="#"><img src="public/images/s1.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="public/images/s2.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="public/images/s3.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="public/images/s4.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="public/images/s5.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="public/images/s6.jpg" alt=""></a>
            </div>
        </div>
    </div>
    <!-- statistics -->
                        ...
                        <div class="card-body d-flex align-items-end  justify-content-center">
                            ...
                            <div class="d-none d-lg-block">
                                <h5 class="text-blue fw-bold purecounter" data-purecounter-start="0"
                                    data-purecounter-end="1285">0</h5>
                                <p class="text-muted">کاربران</p>
                            </div>
                        </div>
                        <div class="card-footer bg-transparent d-lg-none">
                            <h5 class="text-blue fw-bold purecounter" data-purecounter-start="0"
                                data-purecounter-end="1285">0</h5>
                            <p class="text-muted">کاربران</p>
                        </div>
                ...
                <div class="col-12 col-sm-4">
                    <div class="card border-0 text-center bg-transparent">
                        <div class="card-body d-flex align-items-end  justify-content-center">
                            ...
                            <div class="d-none d-lg-block">
                                <h5 class="text-blue fw-bold purecounter" data-purecounter-start="0"
                                    data-purecounter-end="35897">0</h5>
                                <p class="text-muted">دقیقه آموزش</p>
                            </div>
                        </div>
                        <div class="card-footer bg-transparent d-lg-none">
                            <h5 class="text-blue fw-bold purecounter" data-purecounter-start="0"
                                data-purecounter-end="35897">0</h5>
                            <p class="text-muted text-nowrap">دقیقه آموزش</p>
                        </div>
                    </div>
                </div>
                <!-- section -->
                <div class="col-12 col-sm-4">
                    <div class="card border-0 text-center bg-transparent">
                        <div class="card-body d-flex align-items-end  justify-content-center">
                            ...
                            <div class="d-none d-lg-block">
                                <h5 class="text-blue fw-bold purecounter" data-purecounter-start="0"
                                    data-purecounter-end="328">0</h5>
                                <p class="text-muted">دوره ها</p>
                            </div>
                        </div>
                        <div class="card-footer bg-transparent d-lg-none">
                            <h5 class="text-blue fw-bold purecounter" data-purecounter-start="0"
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 mb-4">
                    <div class="card p-3 bg-transparent">
                        <div class="card-body">
                            <!-- title history -->
                            <h4 class="history-title mb-3">نشانه‌ی من برای واضح‌ شدن قدم بعدی‌ام</h4>
                            <!-- text history -->
                            <p class="history-text text-muted">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت
                                چاپ، و
                    ...
                    <div class="card course-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <span class="user-course-card text-muted"><i
                                        class="fa-solid fa-user me-1"></i>جیمز کلیر</span>
                            </div>
                            <hr>
                            <div class="d-flex justify-content-between">
                                <span class="text-success">89,000 تومان</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="card course-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                            <span class="user-course-card text-muted"><i
                                        class="fa-solid fa-user me-1"></i>رابین شارما</span>
                ...
                <div class="item">
                    <div class="card course-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                            <span class="user-course-card text-muted"><i
                                        class="fa-solid fa-user me-1"></i>جو دیسپنزا</span>
                            </div>
                            <hr>
                            <div class="d-flex justify-content-between">
                                <span class="text-success">350,000 تومان</span>
                            </div>
                ...
                <div class="item">
                    <div class="card course-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                            <span class="user-course-card text-muted"><i
                                        class="fa-solid fa-user me-1"></i>جیم کوییک</span>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="d-flex justify-content-between pb-4">
                ...
                <a href="views/courses/courses.php" class="text-orange">مشاهده بیشتر</a>
            </div>
            <div class="d-flex justify-content-between pb-4">
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 mb-4">
                    <div class="card course-card h-100">
                        <a href="<?php echo DOMAIN ?>/courses/course_details"><img src="public/images/course1.jpg"
                                                                                   alt=""
                                                                                   class="card-img-top"></a>
                        <div class="card-body">
                            <h2 class="title-course-card text-truncate mb-3">
                                <a href="<?php echo DOMAIN ?>/courses/course_details">عادت های اتمی</a>
                            </h2>
                            <div class="d-flex justify-content-between">
                            <span class="user-course-card text-muted"><i
                                        class="fa-solid fa-user me-1"></i>جیمز کلیر</span>
                            ...
                            <div class="d-grid">
                                <a href="<?php echo DOMAIN ?>/courses/course_details" class="btn-blue">جزئیات دوره</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel owl-theme" id="categories-bretz">
                ...
                <div class="item">
                    <div class="card bg-transparent border-0">
                        <div class="card-body">
                            <a href="#">
                                <img src="public/images/category1.png" alt="" class="img-fluid">
                                <h6 class="fw-bold text-dark text-truncate">مد و پوشاک</h6>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="card bg-transparent border-0">
                        <div class="card-body">
                            <a href="#">
                                <img src="public/images/category2.png" alt="" class="img-fluid">
                                <h6 class="fw-bold text-dark text-truncate">کالاهای سوپرمارکتی</h6>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="card bg-transparent border-0">
                        <div class="card-body">
                            <a href="#">
                                <img src="public/images/category3.png" alt="" class="img-fluid">
                                <h6 class="fw-bold text-dark text-truncate">ورزش و سفر</h6>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="card bg-transparent border-0">
                        <div class="card-body">
                            <a href="#">
                                <img src="public/images/category4.png" alt="" class="img-fluid">
                                <h6 class="fw-bold text-dark text-truncate">اسباب بازی و کودک</h6>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="card bg-transparent border-0">
                        <div class="card-body">
                            <a href="#">
                                <img src="public/images/category5.png" alt="" class="img-fluid">
                                <h6 class="fw-bold text-dark text-truncate">ابزار و تجهیزات صنعتی</h6>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="card bg-transparent border-0">
                        <div class="card-body">
                            <a href="#">
                                <img src="public/images/category6.png" alt="" class="img-fluid">
                                <h6 class="fw-bold text-dark text-truncate">خانه و آشپزخانه</h6>
                            </a>
                        </div>
                    </div>
                </div>
