                    ...
                    <div class="item">
                        <div class="card course-card h-100">
                            <a href="<?php echo DOMAIN ?>/courses/course_details/<?php echo $course_offer->id ?>"><img
                                        data-src="<?php echo DL_DOMAIN ?>/public/images/course/<?php echo $course_offer->course_image . '/' . $course_offer->course_image ?>"
                            ...
                            <span class="user-course-card text-muted"><i
                                        class="fa-solid fa-user me-1"></i><?php $course_teacher = $this->model->where('admins', 'id', $course_offer->course_teacher); echo $course_teacher->first_name . ' ' . $course_teacher->last_name ?></span>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    switch ($course_offer->course_type) {
                                        case 'money':
                                            ?>
                                            <?php if ($course_offer->course_discount != null) { ?>
                                            <span class="text-success"><?php echo number_format($course_offer->course_price - ($course_offer->course_price * $course_offer->course_discount / 100)) ?> تومان</span>
