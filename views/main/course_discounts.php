                    ...
                    <div class="item">
                        <div class="card course-card h-100">
                            <a href="<?php echo DOMAIN ?>/courses/course_details/<?php echo $course_discounts->id ?>"><img
                                        src="<?php echo DOMAIN ?>/public/images/<?php echo $course_discounts->course_image ?>"
                                        alt="<?php echo $course_discounts->course_title ?>"
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    switch ($course_discounts->course_type) {
                                        case 'money':
                                            ?>
                                            <?php if ($course_discounts->course_discount != null) { ?>
                                            <span class="text-success"><?php echo number_format(($course_discounts->course_price / $course_discounts->course_discount)) ?> تومان</span>
