...
<?php else: ?>
    <div class="d-flex justify-content-center align-items-center">
        <div class="card col-lg-7 py-1">
            <div class="card-body">
                <div class="d-flex">
                    <i class="bi bi-info-circle text-orange fs-6"></i>
                    <p class="ms-2">نتیجه‌ای یافت نشد!</p>
                </div>
                <span class="text-muted fs-7 ms-4">از عبارت‌های متداول‌تر استفاده کنید و یا املای عبارت وارد‌شده را بررسی کنید.</span>
            </div>
        </div>
    </div>
<?php endif; ?>