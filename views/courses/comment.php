...
<div class="card rounded-3 border-0 box-shadow">
    <div class="card-body content-comments hide-content">
        ...
        <div class="collapse" id="form-comment">
            <!-- form comment -->
            <form action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']) ?>/courses/comment" method="post">
                <div class="mb-3">
                    <textarea class="form-control" rows="4" placeholder="نظر خود را بنویسید..." id="comment"></textarea>
                </div>
                <div class="text-end">
