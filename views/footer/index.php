<div class="container-fluid bg-footer py-5">
    <div class="row align-items-center text-center mb-3">
        ...
        <div class="col-12 col-md-4 col-xl-6 col-xxl-4 order-1 order-md-1 order-xxl-0 mb-4 mb-md-0">
            <a href="index.php"><img src="<?php echo DOMAIN ?>/public/images/pubilc-images/logo/logo-footer.png" alt="" class="img-fluid"></a>
        </div>
        <!-- about -->
        <div class="col-12 col-md-12 col-xl-12 col-xxl-4 order-0 order-md-0 order-xxl-1 mb-4 mb-md-5 mb-xxl-0  text-justify">
            <div class="d-flex justify-content-between align-items-baseline pb-4">
                ...
                <a onclick="backTop()" class="btn-white d-xxl-none">برگشت به بالا<i class="fa-solid fa-angle-up ms-3 mt-1"></i></a>
            </div>
        ...
        <div class="col-12 col-md-8 col-xl-6 col-xxl-4 order-2 order-md-2 order-xxl-2 mb-4 mb-md-0">
            <div class="row">
                <div class="col-12 col-sm-4 text-sm-end mb-2">
                    <a href="#"><img src="<?php echo DOMAIN ?>/public/images/pubilc-images/logo-namad/logo-samandehi.png" alt="" class="bg-white rounded p-2" width="120" height="130"></a>
                </div>
                <div class="col-12 col-sm-4 mb-2">
                    <a href="#"><img src="<?php echo DOMAIN ?>/public/images/pubilc-images/logo-namad/logo-ecunion.png" alt="" class="bg-white rounded p-2" width="120" height="130"></a>
                </div>
                <div class="col-12 col-sm-4 text-sm-start mb-2">
                    <a href="#"><img src="<?php echo DOMAIN ?>/public/images/pubilc-images/logo-namad/logo-enamad.png" alt="" class="bg-white rounded p-2" width="120" height="130"></a>
                </div>
            </div>
        </div>
    </div>
